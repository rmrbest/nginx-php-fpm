...
RUN apt-get update && \
    ...
    apt-get update && \
    apt-get upgrade -y && \
    BUILD_PACKAGES="supervisor cron build-essential nginx php5-dev php5-fpm git php5-mysql php-apc php5-curl php5-gd php5-intl php5-mcrypt php5-memcache php5-sqlite php5-tidy php5-xmlrpc php5-xsl php5-pgsql php5-phalcon php5-mongo pwgen git php5-redis php5-cli php5-xdebug " && \
